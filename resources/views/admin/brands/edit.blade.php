                            ...
                            <div class="card-body">
                                <form class="form-horizontal" action="{{ route('brand.update', $brand->id) }}" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="row mb-4">
                                        ...
                                        <div class="col-md-9">
                                            <input class="form-control" id="brandName" name="name" value="{{ $brand->name }}" placeholder="Enter brand name" type="text">
                                        </div>
                                    </div>
                                    <div class="row mb-4">
                                        <label for="description" class="col-md-3 form-label">Description</label>
                                        <div class="col-md-9">
                                            <textarea class="form-control" id="description" cols="30" rows="10" name="description" placeholder="Enter Description">{{ $brand->description }}</textarea>
                                        </div>
                                    </div>
                                    <div class="row mb-4">
