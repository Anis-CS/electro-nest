                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header border-bottom">
                                ...
                                <a href="{{ route('brand.create') }}" class="btn btn-primary ms-auto d-block">Add Brand</a>
                            </div>
                            <div class="card-body">
                                        ...
                                        @foreach($brands as $brand)
                                            <tr>
                                                ...
                                                <td class="justify-content-center">
                                                    <a href="{{ route('brand.edit', $brand->id) }}" class="btn btn-primary btn-sm me-2 float-start">
                                                        <i class="fa fa-edit"></i>
                                                    </a>

                                                    @if($brand->status == 1)
                                                        <a href="{{ route('brand.show', $brand->id) }}" class="btn btn-warning btn-sm me-2 float-start">
                                                            <i class="fa fa-eye-slash"></i>
                                                        </a>
                                                    @else
                                                        <a href="{{ route('brand.show', $brand->id) }}" class="btn btn-success btn-sm me-2 float-start">
                                                            <i class="fa fa-eye"></i>
                                                        </a>
                                                    @endif
