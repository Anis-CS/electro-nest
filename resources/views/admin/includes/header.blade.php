    ...
    <div class="container-fluid main-container">
        <div class="d-flex">
            ...
            <a class="logo-horizontal " href="{{ route('dashboard') }}">
                <img src="{{ asset('/') }}admin/assets/images/brand/el_logo2.png" class="header-brand-img desktop-logo" style="width: 150px; height: 70px" alt="logo">
                <img src="{{ asset('/') }}admin/assets/images/brand/el_logo2.png" style="width: 200px; height: 150px" class="header-brand-img light-logo1"
                     alt="logo">
            </a>
            <!-- LOGO -->
