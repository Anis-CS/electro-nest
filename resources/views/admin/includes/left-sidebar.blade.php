    ...
    <div class="app-sidebar">
        <div class="side-header">
            <a class="header-brand1" href="{{ route('dashboard') }}">
                <img src="{{ asset('/') }}admin/assets/images/brand/el_logo2.png" class="header-brand-img desktop-logo" style="height: 50px; width: 200px;" alt="logo">
                <img src="{{ asset('/') }}admin/assets/images/brand/el_logo2.png" class="header-brand-img toggle-logo" style="height: 50px; width: 200px;" alt="logo">
                <img src="{{ asset('/') }}admin/assets/images/brand/el_logo2.png" class="header-brand-img light-logo" style="height: 50px; width: 200px;" alt="logo">
                <img src="{{ asset('/') }}admin/assets/images/brand/el_logo2.png" class="header-brand-img light-logo1" style="height: 50px; width: 200px;" alt="logo">
            </a><!-- LOGO -->
        </div>
...
{{--                        <li><a href="{{ route('supplier.index') }}" class="slide-item">Supplier/Vendor</a></li>--}}
                        ...
                        <li><a href="{{ route('shipping-area.index') }}" class="slide-item">Shipping Info</a></li>
...
{{--                        <li><a href="{{ route('admin-order.manage') }}" class="slide-item">Complete Order</a></li>--}}
                ...
                <li class="slide">
                    ...
                    <ul class="slide-menu">
                        <li><a href="{{ route('privacy-policy.edit',1) }}" class="slide-item">Manage Policy</a></li>
                    </ul>
                </li>
