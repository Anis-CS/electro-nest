                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <form class="form-horizontal" action="{{ route('offer.update', $offer->id) }}" method="POST" enctype="multipart/form-data">
                                    ...
                                    @method('PUT')
                                    <div class="row mb-4">
                                        <label for="" class="col-md-2 form-label">Product Name</label>
                                        <div class="col-md-10 form-group">
                                            <select multiple name="product[]" data-placeholder="Select Product" class="form-control select2 " id="">
                                                <option>Select Product</option>
                                                @foreach($products as $product)
                                                    <option value="{{ $product->id }}"
                                                            @foreach($offer->offerDetails as $offerDetail) @selected($offerDetail->product_id == $product->id)  @endforeach>
                                                        {{ $product->name }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    ...
                                    <div class="row mb-4">
                                        <label for="color_id" class="col-md-2 form-label">Offer Name</label>
                                        <div class="col-md-10">
                                    ...
                                    <div class="row mb-4">
                                        <label class="col-md-2 form-label">Offer Type</label>
                                        <div class="col-md-10 form-group">
                                            <label class="me-4"><input type="radio" value="1" name="offer_type" {{ $offer->offer_type == '1' ? 'checked' : ' ' }}/>Summer Offer</label>
                                            <label class="me-4"><input type="radio" value="2" name="offer_type" {{ $offer->offer_type == '2' ? 'checked' : ' ' }}/>Combo Offer</label>
                                            <label class="me-4"><input type="radio" value="3" name="offer_type" {{ $offer->offer_type == '3' ? 'checked' : ' ' }}/>Ramadan Offer</label>
                                            <label class="me-4"><input type="radio" value="4" name="offer_type" {{ $offer->offer_type == '4' ? 'checked' : ' ' }}/>Special Offer</label>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row mb-4">
                                        <div class="row">
                                            <label for="" class="col-md-2 form-label">Percentage</label>
                                            <div class="col-md-10">
                                    ...
                                    <div class="row mb-4">
                                        <label for="" class="col-md-2 form-label">Banner Image</label>
                                        <div class="col-md-10">
