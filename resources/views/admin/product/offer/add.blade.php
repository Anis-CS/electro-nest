                            ...
                            <div class="card-body">
                                ...
                                <form class="form-horizontal" action="{{ route('offer.store') }}" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="row mb-4">
                                        ...
                                        <div class="col-md-10 form-group">
                                            <label><input type="radio" value="1" name="offer_type">Summer Offer</label>
                                            <label><input type="radio" value="2" name="offer_type">Combo Offer</label>
                                            <label><input type="radio" value="3" name="offer_type">Ramadan Offer</label>
                                            <label><input type="radio" value="4" name="offer_type">Special Offer</label>
                                        </div>
                                    </div>
