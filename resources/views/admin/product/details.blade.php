                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header border-bottom">
                                ...
                                <a href="{{ route('product.index') }}" class="btn btn-blue ms-auto d-block"><--Go Back</a>
                                <button class="ms-auto">
                                    <a href="{{route('product.edit',$product->id )}}" class="btn btn-success btn-sm ms-2">
                                        <i class="fa fa-edit"></i>
                                    </a>
                                    @if($product->status==1)
                                        <a href="{{route('product.status',$product->id )}}" class="btn btn-danger float-start btn-sm">
                                            <i class="fa fa-eye-slash"></i>
                                        </a>
                                    @else
                                        <a href="{{route('product.status',$product->id )}}" class="btn btn-success float-start btn-sm">
                                            <i class="fa fa-eye"></i>
                                        </a>
                                    @endif
