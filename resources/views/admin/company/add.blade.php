                            ...
                            <div class="card-body">
                                ...
                                <form class="form-horizontal" action="{{ route('company.store') }}" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="row mb-4">
                                        ...
                                        <div class="col-md-9">
                                            <input class="form-control dropify"  name="payment_images[]" type="file"
                                    ...
                                    <div class="row mb-4">
                                        ...
                                        <div class="col-md-9">
                                            <textarea class="form-control" id="copy_write" name="copy_write" placeholder="Enter Copy Write" type="text"></textarea>
                                        </div>
                                    </div>
