                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header border-bottom">
                                ...
                                <a href="{{ route('size.create') }}" class="btn btn-primary ms-auto d-block">Add Size</a>
                            </div>
                            <div class="card-body">
                                        ...
                                        @foreach($sizes as $size)
                                            <tr>
                                                ...
                                                <td class="justify-content-center">
                                                    <a href="{{ route('size.edit', $size->id) }}" class="btn btn-primary btn-sm me-2 float-start">
                                                        <i class="fa fa-edit"></i>
                                                    </a>

                                                    @if($size->status == 1)
                                                        <a href="{{ route('size.show', $size->id) }}" class="btn btn-warning btn-sm me-2 float-start">
                                                            <i class="fa fa-eye-slash"></i>
                                                        </a>
                                                    @else
                                                        <a href="{{ route('size.show', $size->id) }}" class="btn btn-success btn-sm me-2 float-start">
                                                            <i class="fa fa-eye"></i>
                                                        </a>
                                                    @endif
