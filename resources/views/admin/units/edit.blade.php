                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header border-bottom">
                                ...
                                <a href="{{ route('unit.index') }}" class="btn btn-primary ms-auto d-block">Manage Unit</a>
                            </div>
                            <div class="card-body">
                                    ...
                                    <div class="row mb-4">
                                        <div class="col-md-6">
                                            <div class="row">
                                                ...
                                                <div class="col-md-8">
                                                    <input type="text" id="unitName" value="{{ $unit->name }}" class="form-control" name="name" placeholder="Unit Name">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="row">
                                                ...
                                                <div class="col-md-9">
                                                    <input type="text" id="unitCode" value="{{ $unit->code }}" class="form-control" name="code" placeholder="Unit Code">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row mb-4">
                                        <div class="col-md-12">
                                            <div class="row">
                                                ...
                                                <div class="col-md-10">
                                                    <textarea class="form-control" name="description" id="" cols="30" rows="10">{{ $unit->description }}</textarea>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
