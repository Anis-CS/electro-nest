...
<footer class="footer_dark">
                ...
                <div class="col-lg-3 col-md-6 col-sm-12">
                    <div class="widget">
                        <div class="footer_logo">
                          <a href="{{route('home')}}"><img src="{{ asset('/') }}website/assets/images/el_logo1.png" style="height: 80px; width: 300px;" alt="logo"/></a>
                        </div>
                        <p>Can't wait to share our latest project with you. Sign up on our website for updates.</p>
                    </div>
                    <div class="widget">
                ...
                <div class="col-lg-3 col-md-4 col-sm-6">
                    <div class="widget">
                        ...
                        <ul class="contact_info contact_info_light">
                            ...
                            <li>
                                <i class="ti-email"></i>
                                <a href="#">electronest@gmail.com</a>
                            </li>
                            <li>
                                <i class="ti-mobile"></i>
                                <p>+ 457 789 789 65</p>
    ...
    <div class="bottom_footer border-top-tran">
        <div class="container">
            <div class="row">
                <div class="col-md-6">
                    <p class="mb-md-0 text-center text-md-start">© 2022 All Rights Reserved by Electro-Nest Team</p>
                </div>
                <div class="col-md-6">
