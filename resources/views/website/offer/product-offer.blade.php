                                ...
                                <div class="col-md-4 col-6">
                                    <div class="product">
                                        <div class="product_img">
                                            <a href="{{ route('product.details',['id'=>$offerDetail->product_id]) }}">
                                                <img src="{{ asset($offer->image) }}" alt="product_img1">
                                            </a>
                                        ...
                                        <div class="product_info">
                                            <h6 class="product_title"><a href="{{ route('product.details',['id'=>$offerDetail->product_id]) }}">{{ $offer->name }}</a></h6>
                                            <div class="product_price">
                                                <span class="price">BDT.{{ $offerDetail->product->selling_price }}</span>
                                                <del>BDT.{{ $offerDetail->product->regular_price }}</del>
                                                <div class="on_sale">
                                                    <span>{{ $offerDetail->product->discount_amount }}{{ $offer->discount_type == 'fixed' ? 'TK' : '%' }} Off</span>
                                                </div>
                                            </div>
                            ...
                            <div class="widget">
                                <div class="shop_banner">
                                    <div class="banner_img overlay_bg_20">
                                        <img src="{{ asset('/') }}website/assets/images/sidebar_banner_img.jpg" alt="sidebar_banner_img">
                                    </div>
