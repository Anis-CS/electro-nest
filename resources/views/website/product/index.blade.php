                                    ...
                                    <div class="product">
                                        ...
                                        <div class="product_info">
                                            ...
                                            <div class="product_price">
                                                ...
                                                <div class="on_sale">
                                                    <span>Offer:{{ $product->discount_amount }}{{ $product->discount_type == 'fixed' ? '/-' : '%' }}</span>
                                                </div>
                                            </div>
                            ...
                            <div class="widget">
                                <div class="shop_banner">
                                    <div class="banner_img overlay_bg_20">
                                        <img src="{{ asset('/') }}website/assets/images/sidebar_banner_img.jpg"
