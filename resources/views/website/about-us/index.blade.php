                ...
                <div class="row align-items-center">
                    <div class="col-lg-6">
                        <div class="about_img scene mb-4 mb-lg-0">
                            <img src="{{ asset('/') }}website/assets/images/about_img.jpg" alt="about_img"/>
                        </div>
                    </div>
                    <div class="col-lg-6">
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-3 col-sm-6">
                        <div class="team_box team_style1">
                            <div class="team_img">
                                <img src="{{ asset('/') }}website/assets/images/team_img1.jpg" alt="team_img1">
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="team_box team_style1">
                            <div class="team_img">
                                <img src="{{ asset('/') }}website/assets/images/team_img2.jpg" alt="team_img2">
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="team_box team_style1">
                            <div class="team_img">
                                <img src="{{ asset('/') }}website/assets/images/team_img3.jpg" alt="team_img3">
                                <ul class="social_icons social_style4">
                                    <li><a href="#"><i class="ion-social-facebook"></i></a></li>
                                    <li><a href="#"><i class="ion-social-twitter"></i></a></li>
                                    <li><a href="#"><i class="ion-social-googleplus"></i></a></li>
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="team_box team_style1">
                            <div class="team_img">
                                <img src="{{ asset('/') }}website/assets/images/team_img4.jpg" alt="team_img4">
                                <ul class="social_icons social_style4">
                                    <li><a href="#"><i class="ion-social-facebook"></i></a></li>
                                    <li><a href="#"><i class="ion-social-twitter"></i></a></li>
                                    <li><a href="#"><i class="ion-social-googleplus"></i></a></li>
                ...
                <div class="row g-0">
                    <div class="col-lg-4">
                        <div class="icon_box icon_box_style1">
                            ...
                            <div class="icon_box_content">
                                <h5>Free Delivery</h5>
                                <p>Save up to 50% + Free shipping over $49</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4">
                        <div class="icon_box icon_box_style1">
                            ...
                            <div class="icon_box_content">
                                <h5>30 Day Return</h5>
                                <p>We offer Exchange and Replacement with in 30 days.</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4">
                        <div class="icon_box icon_box_style1">
                            ...
                            <div class="icon_box_content">
                                <h5>24/7 Support</h5>
                                <p>We provide 24/7 Customer Service</p>
                            </div>
                        </div>
                    </div>
                </div>
