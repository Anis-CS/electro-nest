...
<head>
    ...
    <!-- TITLE -->
    <title>ElectroNest - Admin Registration Form</title>
    ...
    <div>
        ...
        <div class="col col-login mx-auto text-center">
            <a href="{{ route('dashboard') }}">
                <img src="{{ asset('/') }}admin/assets/images/brand/el_logo1.png" style="height: 100px; width: 380px;" class="header-brand-img" alt="">
            </a>
        </div>
                ...
                <div class="card-body">
                    <form class="login100-form validate-form" method="POST" action="{{ route('register') }}">
                        ...
                        <div class="wrap-input100 validate-input">
                            <input id="email" placeholder="User Email" class="input100" type="email" name="email" :value="old('email')" required autocomplete="username">
                        ...
                        <div class="wrap-input100 validate-input" data-bs-validate = "Password is required">
                            <input id="password" placeholder="Password" class="input100" type="password" name="password" required autocomplete="new-password">
                            <span class="focus-input100"></span>
                            <span class="symbol-input100">
                        ...
                        <div class="wrap-input100 validate-input" data-bs-validate = "Password is required">
                            <input id="passwordConfirmation" placeholder="Confirm Password" class="input100" type="password" name="password_confirmation" required autocomplete="new-password">
                            <span class="focus-input100"></span>
                            <span class="symbol-input100">
                                <i class="zmdi zmdi-lock" aria-hidden="true"></i>
                            </span>
                        ...
                        @if (Laravel\Jetstream\Jetstream::hasTermsAndPrivacyPolicyFeature())
                            <label class="custom-control custom-checkbox mt-4">
                                ...
                                <span class="custom-control-label">Agree the <a href="terms.html">terms andpolicy</a></span>
                            </label>
                        @endif
