...
class Company extends Model
{
    ...
    private static $company,$image, $imageUrl, $directory, $imageName, $extension, $images;
    ...
    public static function newCompany($request){
        ...
        self::$company->copy_write          =$request->copy_wite;
        self::$company->save();
    }
    ...
    public static function updateCompany($request, $id)
    {
        ...
        self::$company->address         = $request->address;
        self::$company->biography       = $request->biography;
        self::$company->copy_write      =$request->copy_write;
        self::$company->save();
    }
